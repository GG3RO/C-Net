    ...
    public partial class migrimi1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PjesmarrjaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pjesmarrjet", x => x.PjesmarrjaId);
                    table.ForeignKey(
                        name: "FK_pjesmarrjet_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_pjesmarrjet_Weddings_WeddingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pjesmarrjet_UserId",
                table: "pjesmarrjet",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_pjesmarrjet_WeddingId",
                table: "pjesmarrjet",
                column: "WeddingId");
